...
- **Plan path**: [resolved with `scripts/resolve-plan-path.mjs`; default shape `~/.codex/plans/[baseRepo]/[kebab-case-name].plan.md`]
- **Created**: YYYY-MM-DD
- **Primary repo**: [repo name]
- **Target branch / JIRA**: [branch and JIRA-ID or warning]

## Source of Request

- **JIRA**: [JIRA-ID or "not provided"]
...
|---|---|---|---|---|---|---|
| [primary-repo] | Primary implementation repo | `/path/to/repo` | `feature/JIRA-1234-name` | Safe | Observed: `git -C /path branch --show-current` | [files/sections likely affected] |
...
|---|---|---|---|
| AC-001 | [testable criterion] | [JIRA, requirements doc, prompt, or Observed evidence] | TM-001, Phase 1 |
...
- **Suggested commit**: `type(JIRA-ID): description`
