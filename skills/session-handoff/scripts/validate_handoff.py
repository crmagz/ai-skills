...
Usage:
    ...
    python validate_handoff.py .codex/handoffs/2024-01-15-143022-auth.md
"""
...
from handoff_paths import project_root_for_handoff
...
def validate_handoff(filepath: str) -> dict:
    ...
    base_path = project_root_for_handoff(path)
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python validate_handoff.py .codex/handoffs/2024-01-15-auth.md")
        sys.exit(1)
