...
Usage:
    ...
    python check_staleness.py .codex/handoffs/2024-01-15-143022-auth.md
"""
...
def check_staleness(handoff_path: str) -> dict:
    ...
    if not project_path or not Path(project_path).exists():
        project_path = str(project_root_for_handoff(path))
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python check_staleness.py .codex/handoffs/2024-01-15-auth.md")
        sys.exit(1)
