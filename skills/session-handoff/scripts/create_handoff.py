...
from handoff_paths import handoff_dirs, primary_handoffs_dir
...
def find_previous_handoffs(project_path: str) -> list[dict]:
    ...
    handoffs = []
    primary_dir = primary_handoffs_dir(project_path)
    for handoffs_dir in handoff_dirs(project_path):
        ...
        for filepath in handoffs_dir.glob("*.md"):
            ...
            handoffs.append({
                ...
                "path": str(filepath),
                "relative_path": os.path.relpath(filepath, primary_dir),
                "title": title,
                "date": date,
            })
...
def get_previous_handoff_info(project_path: str, continues_from: str = None) -> dict:
    ...
    if continues_from:
        ...
        return {
            ...
            "relative_path": most_recent["relative_path"],
...
def generate_handoff(
    ...
    handoffs_dir = primary_handoffs_dir(project_path)
...
- **Continues from**: [{prev_handoff['filename']}](./{prev_handoff['relative_path']})
