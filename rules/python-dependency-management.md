...
All MSP services deploy on EKS. Use a multi-stage Dockerfile with uv for dependency installation:
...
ARG REGISTRY=<aws-account-id>.dkr.ecr.us-east-1.amazonaws.com/docker-hub/library/
ARG UV_REGISTRY=<aws-account-id>.dkr.ecr.us-east-1.amazonaws.com/docker-hub/
