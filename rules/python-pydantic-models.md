...
class MigrationRequest(BaseModel):
    ...
    app_name: str = Field(description="Target application repository name", examples=["app-billing-api"])
    owner: Owner = Field(description="Team owner — determines config repo and namespace")
    jira_id: str = Field(description="JIRA issue ID for commits", examples=["FALCON9-2423"])
